...
print(f"Quantidade de Caracteres (Desconsiderando espaços: {len(nome_completo) - nome_completo.count(' ')}")
print(f"Seu primeiro nome é {nome_completo.split()[0]} e tem {len(nome_completo.split()[0])} letras")